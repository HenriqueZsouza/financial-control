...
export interface GetCurrentUser { execute(userId: string): Promise<UserPublic> }
export interface UpdateCurrentUser { execute(userId: string, input: UpdateCurrentUserInput): Promise<UserPublic> }
