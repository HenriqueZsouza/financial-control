...
export interface FamilyInvite { id: number; familyGroupId: number; inviterId: number; inviteeId: number; inviteeEmail: string; status: FamilyInviteStatus; createdAt: Date; }
