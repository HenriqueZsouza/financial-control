...
const fields = z.object({
  type: z.enum(['INCOME', 'EXPENSE']), name: z.string().trim().min(1).max(160), amount: z.number().int().positive('O valor deve ser informado em centavos.'), categoryId: z.string().min(1),
