...
export const openApiSchemas = {
  ...
  DashboardSummary: {
    ...
    properties: {
      ...
      openingBalance: { type: 'integer', description: 'Saldo herdado do mês anterior (entradas − despesas à vista CASH com date anterior ao período), em centavos.', example: 30000 },
      totalIncome: { type: 'integer', description: 'Valor monetário em centavos.', example: 500000 },
      totalExpense: { type: 'integer', description: 'Despesas à vista (CASH) em centavos. CREDIT_1X e INSTALLMENT não entram.', example: 150000 },
      totalInvestment: { type: 'integer', description: 'Valor monetário em centavos. Não entra no saldo.', example: 200000 },
      balance: { type: 'integer', description: 'openingBalance + entradas − despesas à vista do período, em centavos. Investimentos e compras no cartão não entram.', example: 380000 },
